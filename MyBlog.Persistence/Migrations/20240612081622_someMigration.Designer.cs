...
namespace MyBlog.Persistence.Migrations
{
    ...
    [Migration("20240612081622_someMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.WriteEntity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Phone", "MyBlog.Domain.Entities.WriteEntity.AppUser.Phone#PhoneValue", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.WriteEntity.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.WriteEntity.Comment", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.WriteEntity.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ArticleTag", b =>
                {
                    b.HasOne("MyBlog.Domain.Entities.WriteEntity.Article", null)
                        .WithMany()
                    ...
                    b.HasOne("MyBlog.Domain.Entities.WriteEntity.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.WriteEntity.Article", b =>
                {
                    b.HasOne("MyBlog.Domain.Entities.WriteEntity.AppUser", "Author")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("MyBlog.Domain.Entities.WriteEntity.Comment", b =>
                {
                    b.HasOne("MyBlog.Domain.Entities.WriteEntity.Article", "Article")
                        .WithMany("Comments")
